...
/**
 * Estrategia para una sola petición de servicio individual.
 */
export class SingleIndividualAssignmentStrategy implements AssignmentModeStrategy {
    public readonly mode = "single-individual" as const;

    /**
     * Intenta asignar un profesional para un único servicio individual al inicio elegido.
     */
