...
const legacyClientEventService = new ClientEventService();
...
export class EventClientCommandService {
    ...
    public async addFromWeb(ctx: any) {
        ...
        const result: any = await legacyClientEventService.addEventFromWeb(servicePayload, deps);
    ...
    public async updateFromWeb(ctx: any) {
        ...
        const result: any = await legacyClientEventService.updateSingleEventFromWeb(servicePayload, deps);
