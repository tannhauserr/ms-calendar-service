...
router.post('/user-services/add', JWTService.verifyCookieToken, controller.add);
...
router.post('/user-services/delete', JWTService.verifyCookieToken, controller.delete);
