...
import { CategoryEstablishmentService } from "../../services/@database/category-establishment/category-establishment.service";
import { JWTService } from "../../services/jwt/jwt.service";

export class CategoryEstablishmentController {
    private categoryEstablishmentService: CategoryEstablishmentService;
    private jwtService: JWTService;

    constructor() {
        this.jwtService = JWTService.instance;
        this.categoryEstablishmentService = new CategoryEstablishmentService();
    }
    ...
    public get = async (req: any, res: any, next: any) => {
        try {
            ...
            const result = await this.categoryEstablishmentService.get(pagination);
    ...
    public getById = async (req: any, res: any, next: any) => {
        try {
            ...
            const result = await this.categoryEstablishmentService.getById(Number(id));
    ...
    //         const result = await this.categoryEstablishmentService.add(body);
    ...
    public addMultiple = async (req: any, res: any, next: any) => {
        try {
            ...
            const result = await this.categoryEstablishmentService.addMultipleCategoryEstablishment(body);
    ...
    public delete = async (req: any, res: any, next: any) => {
        try {
            ...
            const result = await this.categoryEstablishmentService.deleteMultiple(idList);
