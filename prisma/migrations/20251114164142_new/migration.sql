...
-- CreateEnum
CREATE TYPE "EventStatusType" AS ENUM ('PENDING', 'ACCEPTED', 'CONFIRMED', 'COMPLETED', 'CANCELLED', 'CANCELLED_BY_CLIENT', 'CANCELLED_BY_CLIENT_REMOVED', 'PAID', 'NO_SHOW');
...
CREATE TABLE "events" (
    ...
    "serviceMaxParticipantsSnapshot" INTEGER DEFAULT 1,
